...
agg=$(awk -F'\t' "$COREIDS_AWK"'
    ...
    NR == FNR { oc[$1] = $2; sz[$1] = $8; dt[$1] = $4; tm[$1] = $5; skf[$1] = $6; cn[$1] = $16; next }
    $16 == "" { next }
