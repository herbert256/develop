...
write_analyses_index() {
    local out="$ADIR/index.html"
    {
        ...
        [ -f "$ADIR/fe-overview.html" ] && printf '<tr><td><a href="fe-overview.html">FE overview</a></td><td class="desc">Every FE login on one line: its use cases, the last logon here and on the old gateway, its Files in / out with the collected, Waiting and Expired ones, and its pickups with their cadence.</td></tr>\n'
